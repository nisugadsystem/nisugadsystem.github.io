...
$resEmails = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM members_tbl WHERE email = '{$_REQUEST['email']}'"));
              ...
              <div class="card card-plain mt-8">
                ...
                <form action="verify_code.php?email=<?php echo $resEmails['email']; ?>" method="POST">
                  ...
                  if (isset($_REQUEST['btnCheckCode'])) {
                  	...
                  	$resCode = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM members_tbl WHERE email = '{$resEmails['email']}' AND code = '$code'"));
