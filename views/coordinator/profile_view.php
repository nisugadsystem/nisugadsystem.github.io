...
<div data-growl="container" class="alert alert-warning alert-dismissable growl-animated animated fadeInDown alerts" role="alert" data-growl-position="top-right" style="" id="unameEx">
  ...
  <form action="../../controller/coordinator/process/save_data.php" method="POST" enctype="multipart/form-data">
              ...
              <div>
                ...
                <div class="pl-lg-4">
                  ...
                  <div class="row">
                    ...
                    <input type="hidden" name="coordinator_id" value="<?php echo $resSession['coordinator_id'] ?>">
                    <div class="col-lg-4">
                      <div class="form-group focused">
