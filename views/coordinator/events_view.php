			...
			<div class="white_card card_height_100 mb_30">
				...
				<div class="white_card_body">
					...
					<?php
						...
						$query = mysqli_query($con, "SELECT * FROM events_tbl WHERE archive_status = '1' AND department_id = '$my_department_id' AND school_id = '$my_school_id' ORDER BY event_id DESC");
							...
							<tbody>
								...
								while ($row = mysqli_fetch_assoc($query)) {
									...
									<tr>
										...
										<td>
											<?php echo $resS['school_abbreviation'].' - '.$resD['department_abbreviation']; ?>
										</td>
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
	        ...
	        <div class="row">
	        	<div class="col-md-6">
	        		<input type="hidden" name="user_id" value="<?php echo $resSession['coordinator_id']; ?>">
	        		<input type="hidden" name="user_username" value="<?php echo $username; ?>">
	        		<input type="hidden" name="school_id" value="<?php echo $my_school_id; ?>">
	        		<input type="hidden" name="department_id" value="<?php echo $my_department_id; ?>">
...
<script type="text/javascript">
	function archiveEvent(e_id) {
		if (confirm('Archive Event?')) {
			window.location.href='../../controller/coordinator/process/edit_data.php?e_id='+e_id+'&btnArchiveEvent=1&global_url=<?php echo $url; ?>';
		}
	}
</script>
