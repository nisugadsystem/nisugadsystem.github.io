			...
			<div class="white_card card_height_100 mb_30">
				...
				<div class="white_card_body">
					<div class="row">
						...
						<a href="" class="btn btn-primary">Refresh</a> &nbsp; <a href="#" class="btn btn-success" title="Add New Coordinator">Add</a>
						<?php
						if (isset($_REQUEST['btnFilter'])) {
							$searchField = $_REQUEST['searchField'];
							$query = mysqli_query($con, "SELECT * FROM coordinators_tbl WHERE fname LIKE '%$searchField%' OR mname LIKE '%$searchField%' OR lname LIKE '%$searchField%'");
						}else{
							$query = mysqli_query($con, "SELECT * FROM coordinators_tbl ORDER BY lname ASC");
						}
						?>
					</div>
					<br>
						...
						<table class="table table-bordered">
							...
							<tbody>
								...
								while ($row = mysqli_fetch_assoc($query)) {
									...
									<tr>
										<td><?php echo $i++; ?></td>
										<td><a href="user_profile_view?m_id=<?php echo $row['member_id']; ?>"><?php echo $row['fname']; ?></a></td>
