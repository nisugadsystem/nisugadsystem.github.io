...
$resDep = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM departments_tbl WHERE department_id = '{$userRes['department_id']}'"));
$resSchool = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM schools_tbl WHERE school_id = '{$userRes['school_id']}'"));
$resGend = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM gender_tbl WHERE gender_id = '{$userRes['gender']}'"));
$resRole = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM role_tbl WHERE role_id = '{$userRes['role']}'"));
?>
              ...
              <div>
                ...
                <div class="pl-lg-4">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        ...
                        <select class="form-control" name="gender" required="" readonly="true" disabled="true">
                          <option value="<?php echo $userRes['gender']; ?>"><?php echo $resGend['gender_name']; ?></option>
                        </select>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        ...
                        <select class="form-control" name="role" required="" readonly="true" disabled="true">
                          <option value="<?php echo $userRes['role']; ?>"><?php echo $resRole['role_name']; ?></option>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        <label class="form-control-label" for="input-last-name">School</label>
                        <select class="form-control" name="gender" required="" readonly="true" disabled="true">
                          <option value="<?php echo $userRes['gender']; ?>"><?php echo $resSchool['school_name']; ?></option>
                        </select>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        <label class="form-control-label" for="input-last-name">Deparment</label>
                        <select class="form-control" name="role" required="" readonly="true" disabled="true">
                          <option value="<?php echo $userRes['role']; ?>"><?php echo $resDep['department_name']; ?></option>
                        </select>
                      </div>
                    </div>
                  </div>
