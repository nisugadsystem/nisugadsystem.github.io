...
session_start();
$action_url = "../../controller/coordinator/process/";

$username = $_SESSION['username'];

$resSession = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM coordinators_tbl WHERE username = '$username'"));
$my_school_id = $resSession['school_id'];
$my_department_id = $resSession['department_id'];
$resSchool = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM schools_tbl WHERE school_id = '$my_school_id'"));
$resDep = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM departments_tbl WHERE department_id = '$my_department_id'"));
...
$resSystemSettings = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM system_settings_tbl"));
?>
<!DOCTYPE html>
<html lang="zxx">
<head>
...
<h3><?php echo $resSystemSettings['system_title']; ?></h3>
...
<p><?php echo $resSchool['school_abbreviation'].' - '.$resDep['department_abbreviation']; ?> </p>
<label style="color: white;"><?php echo ucfirst($resSession['fname'])." ".ucfirst($resSession['lname']); ?></label><br>
<label style="color: white;">Coordinator</label>
</div>
