					...
					<div class="row" action="users_view" method="POST">
						...
						if (isset($_REQUEST['btnFilter'])) {
							...
							if ($searchField == '' && $gender == 'All') {
								...
								$query = mysqli_query($con, "SELECT * FROM members_tbl WHERE account_status = '0' ORDER BY lname ASC");

							}elseif ($searchField != '' && $gender == 'All') {
								
								$query = mysqli_query($con, "SELECT * FROM members_tbl WHERE fname LIKE '%$searchField%' AND account_status = '0' OR lname LIKE '%$searchField%' AND account_status = '0' OR contact_number LIKE '%$searchField%' AND account_status = '0' OR email LIKE '%$searchField%' AND account_status = '0' OR username LIKE '%$searchField%' AND account_status = '0' OR mname LIKE '%$searchField%' AND account_status = '0' ");
								...
								$query = mysqli_query($con, "SELECT * FROM members_tbl WHERE fname LIKE '%$searchField%' AND gender = '$gender' AND account_status = '0' OR mname LIKE '%$searchField%' AND gender = '$gender' AND account_status = '0' OR lname LIKE '%$searchField%' AND gender = '$gender' AND account_status = '0' OR contact_number LIKE '%$searchField%' AND gender = '$gender' AND account_status = '0' OR email LIKE '%$searchField%' AND gender = '$gender' AND account_status = '0' OR username LIKE '%$searchField%' AND gender = '$gender' AND account_status = '0' ");
