            ...
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a >
                    <img style="height: 180px;" src="<?php if(empty($resSession['profile_image'])){ echo '../../profile_images/empty.jpg'; }else{ echo $resSession['profile_image']; } ?>" class="rounded-circle">
                  </a>
                </div>
              </div>
            </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        ...
                        <input type="email" name="email" class="form-control form-control-alternative" placeholder="Email" value="<?php echo $resSession['email']; ?>">
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="form-group focused">
                        ...
                        <input type="text" name="username" class="form-control form-control-alternative" placeholder="Username" value="<?php echo $resSession['username']; ?>">
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group focused">
                        <label class="form-control-label" for="input-last-name">Password</label>
                        <input type="password" name="password" class="form-control form-control-alternative" placeholder="Password" value="<?php echo $resSession['password']; ?>">
                      </div>
                    </div>
                    <input type="hidden" name="user_id" value="<?php echo $resSession['user_id'] ?>">
                    <div class="col-lg-4">
                      <div class="form-group focused">
