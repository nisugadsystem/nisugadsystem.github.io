			...
			<div class="white_card card_height_100 mb_30">
				...
				<div class="white_card_body">
					...
					<?php
						...
						$query = mysqli_query($con, "SELECT * FROM events_tbl WHERE archive_status = '0' ORDER BY event_id DESC");
						...
						<table class="table table-bordered">
							...
							<tbody>
								...
								while ($row = mysqli_fetch_assoc($query)) {
									$resUname = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM coordinators_tbl"));
									...
									<tr>
										...
										<td>
											<?php
											$resReports = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM reports_tbl WHERE event_id = '$event_id'"));
											if (empty($resReports['report_id'])) {
												?>
												<a href="" data-toggle="modal" data-target="#add_report<?php echo $event_id; ?>"><span class="badge badge-info">Add Report</span></a>
												<?php
											}else{
												echo "N/A";
											}
											?>
											<div class="modal fade" id="add_report<?php echo $event_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
											  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
											    <div class="modal-content">
											      ...
											      <div class="modal-body">
												        ...
												        <div class="row">
												        	<div class="col-md-12">
												        		...
												        		<input type="text" name="event_title" class="form-control" readonly="" value="<?php echo $row['event_title']; ?>">
												        ...
												        while ($rGend = mysqli_fetch_assoc($qGend)) {
												        	...
												        	<div class="row">
												        		<div class="col-md-12">
												        			<label><?php echo $rGend['gender_name']; ?></label>
												        			
												        			<input type="hidden" name="gender_id[]" value="<?php echo $rGend['gender_id']; ?>" class="form-control">
												        			<input type="number" name="no_attended[]" value="" class="form-control" placeholder="No. Attended">
												        		</div>
												        	</div>
												        	<br>
												        	<?php
											      ...
											      <div class="modal-footer">
											        ...
											        <input type="submit" name="btnAddReport" value="Save" class="btn btn-primary">
											      </div>
											      </form>
											    </div>
											  </div>
