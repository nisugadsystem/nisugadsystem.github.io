...
if (isset($_POST['btnUserReg'])) {
	//echo "string";
	$fname = mysqli_escape_string($con, ucfirst($_POST['fname']));
	$mname = mysqli_escape_string($con, ucfirst($_POST['mname']));
	$lname = mysqli_escape_string($con, ucfirst($_POST['lname']));
