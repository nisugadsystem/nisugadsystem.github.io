...
if (isset($_REQUEST['btnEditProfile'])) {
	$fname = mysqli_escape_string($con, ucfirst($_REQUEST['fname']));
	$mname = mysqli_escape_string($con, ucfirst($_REQUEST['mname']));
	$lname = mysqli_escape_string($con, ucfirst($_REQUEST['lname']));
