                ...
                <div class="card-body">
                  ...
                  <form action="change_password.php?email=<?php echo $_REQUEST['email']; ?>" method="POST">
                    ...
                    if (isset($_REQUEST['btnChangePass'])) {
                    	...
                    	$query = mysqli_query($con, "UPDATE members_tbl SET password = '$confirm_password' WHERE email = '{$_REQUEST['email']}'");
                    	if ($query) {
                    		$qCode = mysqli_query($con, "UPDATE members_tbl SET code = '' WHERE email = '{$_REQUEST['email']}'");
